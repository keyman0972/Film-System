...
<s:form method="post" theme="simple" action="%{progAction}">
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="0">
			<tr class="trBgOdd">
				...
				<td width="30%"><s:property value="labFilmMst.filmId" /></td>
				<td width="20%" class="colNameAlign required">*<s:text name="filmName"/>：</td>
				<td width="30%"><s:property value="labFilmMst.filmName"/></td>
			</tr>
			<tr class="trBgEven">
				<td width="20%" class="colNameAlign required">*<s:text name="fmCorpId"/>：</td>
				<td width="30%">
					<s:property value="labFilmMst.labFilmCorpMst.fmCorpId"/>&nbsp;-&nbsp;<s:property  value="labFilmMst.labFilmCorpMst.fmCorpName" />
				</td>
